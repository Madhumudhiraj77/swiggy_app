    ...
    const fetchCatResData = async () => {
      try {
        ...
        let response = await fetch(
          `http://localhost:3001/proxy?url=${encodeURIComponent(`https://www.swiggy.com/dapi/restaurants/list/v5?lat=17.387158&lng=78.545031&collection=${collectionId}&tags=${tags}&sortBy=&filters=&type=rcv2`)}`
        );
